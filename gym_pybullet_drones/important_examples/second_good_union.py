...
def run(
    ...
    INIT_XYZ,   TARGET_POS_1 = pc.circle(Radius, small_size, x, y, z, 0.5)
    INIT_XYZ_2, TARGET_POS_2 = pc.cone(Radius, small_size, h, TARGET_POS_1[small_size-1][0], TARGET_POS_1[small_size-1][1], TARGET_POS_1[small_size-1][2], 2)
    INIT_XYZ_2, TARGET_POS_3 = pc.circle(-Radius, small_size,TARGET_POS_2[small_size-1][0], TARGET_POS_2[small_size-1][1], TARGET_POS_2[small_size-1][2], 0.5)
    INIT_XYZ_2, TARGET_POS_4 = pc.cylinder(-Radius, small_size, h, TARGET_POS_3[small_size-1][0], TARGET_POS_3[small_size-1][1], TARGET_POS_3[small_size-1][2], 2)
