...
def run(
    ...
    INIT_XYZ, TARGET_POS_1 = pc.circle(Radius, small_size, 0, 0, 0.3, segment=0.5)
    INIT_XYZ_2, TARGET_POS_2 = pc.cylinder(Radius/2, small_size, height,TARGET_POS_1[small_size-1][0], TARGET_POS_1[small_size-1][1], TARGET_POS_1[small_size-1][2])
    
    for i in range(int(small_size)):
        TARGET_POS[i] = TARGET_POS_1 [i]
    for i in range(int(small_size)):
        TARGET_POS[i+int(small_size)] = TARGET_POS_2[i]
